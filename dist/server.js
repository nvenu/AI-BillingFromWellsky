...
exports.resetStopFlag = resetStopFlag;
exports.broadcastLog = broadcastLog;
require("dotenv/config");
const express_1 = __importDefault(require("express"));
const kinnser_billing_automation_1 = require("./kinnser-billing-automation");
...
(0, kinnser_billing_automation_1.setLogBroadcaster)(broadcastLog);
// Set up stop check function
(0, kinnser_billing_automation_1.setStopCheckFunction)(isStopRequested);
...
app.get("/api/insurances/:stateCode", (req, res) => {
    try {
...
app.get("/billing", (req, res) => {
    ...
    const officeButtons = office_config_1.OFFICES.map(office => `
        ...
        <div class="main-content">
          ...
          <div class="all-offices-section">
            <button class="all-offices-btn" onclick="runAutomation('all', 'All Offices', 'ALL')">
              ...
              Process All Offices (${office_config_1.OFFICES.length} locations)
            </button>
          </div>
